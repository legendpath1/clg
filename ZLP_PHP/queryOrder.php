...
<table width="60%" border="0" align="center" cellpadding="0"
	...
	<tr>
		<td>
		<form method="post" action="queryOrderServer.php">
		<table width="100%" border="0" align="center" cellpadding="5"
			...
			<?php 
				...
				if($tips != null && $tips != "") {
					...
					echo "<tr><td colspan='2'>查询结果:".$tips." || 订单状态:".$state."(注：订单状态00-支付成功，其他为失败);</td></tr>";
				}
			?>
			<tr>
				<td colspan="2">&nbsp;</td>
			...
			<tr>
				<td>商户订单号</td>
				<td>&nbsp;&nbsp;<input size="50" type="text" name="outOrderId" id="outOrderId" value="<?php echo($_POST['outOrderId']) ?>" />&nbsp;<span
