...
<script type="text/javascript">
    jQuery("document").ready( function(){
        $("#bank").change(function(){
            ...
            if( id==19 ){
				...
				$("tr[title='bankinfo']").hide();
				$("span[id^='banknameinfo']").html("支付宝号码");
				$("#cardno_msg").html("( 支付宝号码由5-25位数字组成 )");
				$("#cardno_again_msg").html("( 支付宝确认号码由只能手动输入, 不能粘贴 )");
            }else{
    ...
    function checkform(obj){
        ...
        if( bankid == 19 ){
			...
			var cardno = document.getElementById("cardno");
			if (!re.test(cardno.value)){
				alert('"支付宝号码" 不符合规则, 请重新输入');
				cardno.focus();
				return false;
			}
			var cardno_again = document.getElementById("cardno_again");
			if (cardno.value != cardno_again.value){
				alert('两次填写的 "支付宝号码" 不相同, 请仔细核对后再次提交');
				cardno_again.focus();
				return false;
			}
        }else{
...
<div class="rc_con binding">
    ...
    <h5><div class="rc_con_title">绑定银行卡</div></h5>
    <div class="rc_con_to">
        <div class="rc_con_ti">
...
<?php
$sqla = "select * from ssc_banks WHERE zt2='1' and tc='".$tcbank."' order by id asc";
...
<?php }?>
                        ...
                        <tr title="bankinfo" class="branch">
                            ...
                            <td>
                                <input class="needdesc" type="text" name="branch" maxlength="20" id="branch" onkeyup="exceptSpecial(this);" onchange="exceptSpecial(this);" style='width:220px;'/><span class="pop"><s class="pop-l"></s><span>（由1至20个字符或汉字组成, 不能使用特殊字符）</span><s class="pop-r"></s></span>
                            </td>
                        </tr>
                        <tr>
                            <td class="nl"><font color="#FF0000">*</font>&nbsp;开户人姓名:</td>
                            <td>
                                <input class="needdesc" type="text" name="realname" maxlength="15" id="realname" onkeyup="exceptSpecial(this);" onchange="exceptSpecial(this);" style='width:220px;' /><span class="pop"><s class="pop-l"></s><span>（由1至30个字符或汉字组成, 不能使用特殊字符）</span><s class="pop-r"></s></span>
                            </td>
                        </tr>
                        <tr>
                            <td class="nl"><font color="#FF0000">*</font>&nbsp;<span id="banknameinfo_1">银行账号</span>:</td>
                            <td>
                                <input class="needdesc" maxlength="19" type="text" name="cardno" id="cardno"  style="width:220px;" /><span class="pop"><s class="pop-l"></s><span>（银行卡账号由16位或19位数字组成）</span><s class="pop-r"></s></span>
                            </td>
                        </tr>
                        <tr>
                            <td class="nl"><font color="#FF0000">*</font>&nbsp;确认<span id="banknameinfo_2">银行账号</span>:</td>
                            <td>
                                <input class="needdesc" maxlength="19" type="text" name="cardno_again" id="cardno_again" onpaste="return false" style="width:220px;" /><span class="pop"><s class="pop-l"></s><span>（银行账号只能手动输入, 不能粘贴）</span><s class="pop-r"></s></span>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <input name="submit" value="下一步" type="submit" width='69' height='26' class="btn_next" />
                            </td>
                        </tr>
                    </form>
                </table>
