...
var op=$.extend({container:"#container",collapse:".collapse",toggleBut:".toggleCollapse div",sideBar:"#sidebar",sideBar2:"#sidebar_s"},options);
return this.each(function(){
var jbar=this;
...
var iContentH=$(window).height()-$("#header").height()-15;
$("#container").width(iContentW);
$("#container .tabsPageContent").height(iContentH-34).find("[layoutH]").layoutH();
$("#container .tabsPageContent").css({"overflow":"auto"});
$("#sidebar, #sidebar_s .collapse, #splitBar").height(iContentH-5);
...
thead.wrap("<div class='gridHeader'><div class='gridThead'><table style='width:"+tlength+"px;'></table></div></div>");//<table style='width:"+(tlength-20)+"px;'></table>
...
tbody.wrap("<div class='gridScroller'"+layoutStr+" style='width:"+$tc.width()+"px;'><div class='gridTbody'><table style='width:"+tlength+"px;'></table></div></div>");
